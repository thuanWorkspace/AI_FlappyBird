...
public class Pipe {
	...
	public Pipe() {
		...
		try {
			pointSound = Applet.newAudioClip(new URL("file", "", "dataFlapp/point.wav"));
...
//		g.drawRect(topRect.x, topRect.y, topRect.width,top);
//		g.drawLine(0, top, GameScreen.width, top);
//		g.drawLine(0, bot, GameScreen.width, bot);
	}
