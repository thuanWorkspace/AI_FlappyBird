...
import genetic_algorithm_neat.neat.Neat;
...
public class GameScreen extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		g.drawString("current time: " + currentMinute +"m"+" "+currentTime+"s", (int) (width * 0.025), (int) (height * 1.1));
		g.drawString("total time: " + total_Minute +"m"+" "+total_second+"s", (int) (width * 0.025), (int) (height * 1.2));
		g.drawString("highest time: " + highestMinute +"m"+" "+highestTime+"s", (int) (width * 0.6), (int) (height * 1.1));
