...
public class GameJFrameTestDrive {
	...
	static boolean openBFS = false;
	static boolean openAStart = false;
	...
	public static void main(String[] args) {
		...
		JFrame f = new JFrame("flapp A* with beauti");
		...
		JButton jbtOpenBFS = new JButton("BFS");
		jpnAdd.add(jbtOpenBFS);
		jbtOpenBFS.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				screen.setRunBFS(openBFS);
			}
		});
		JButton jbtOpenAStar = new JButton("a*");
		jpnAdd.add(jbtOpenAStar);
		jbtOpenAStar.addActionListener(new ActionListener() {
